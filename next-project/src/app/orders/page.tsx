...
import { FaBox, FaClock, FaCheck, FaTruck, FaInfoCircle } from 'react-icons/fa';
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6 mt-[120px]">
        ...
        {isLoading ? (
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Você ainda não tem pedidos</h2>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-medium mb-2 text-gray-800">Informações do Pedido</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2 text-gray-800">Endereço de Entrega</h3>
                  <div className="bg-gray-50 p-4 rounded-md">
                    <p className="text-sm text-gray-600 mb-1">
              ...
              <div>
                <h3 className="text-lg font-medium mb-4 text-gray-800">Produtos</h3>
