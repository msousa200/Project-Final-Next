...
const Cart = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 mt-[120px]">
      <h2 className="text-3xl font-bold mb-8 text-gray-800 text-center">Carrinho de Compras</h2>
      ...
      {cartItems.length === 0 ? (
        ...
        <>
          <ul className="space-y-4 mb-8">
            {cartItems.map((item) => (
              <li key={item.id} className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <button
                className="flex-1 px-6 py-3 rounded-lg bg-black text-white font-medium hover:bg-gray-900 transition-colors"
              >
                Finalizar Compra
              </button>
            </div>
